...
<form method="post"  action=""> <div id="titulo">Crear Cuenta</div>
    <div class="form-row">
      <div class="col-md-2 mb-3">
        ...
        <input type="text" name="nombre" class="form-control" id="validationDefault01" placeholder="Nombre" value="<?= isset($arraydeerrores["nombre"]) ?"" :$_POST["nombre"] ?>">
        <small><?= isset($arraydeerrores["nombre"])? $arraydeerrores["nombre"]:"" ?></small>
      </div>
      <div class="col-md-2 mb-3">
        <label for="validationDefault02">Apellido</label>
        <input type="text" class="form-control" id="validationDefault02" placeholder="Apellido"  >
      </div>
      <div class="col-md-3 mb-3">
        <label for="validationDefault01">Email</label>
        <input type="email" name="mail" class="form-control" id="validationDefault01" placeholder="Email"  value="<?= isset($arraydeerrores["mail"]) ?"" :$_POST["mail"] ?>" >
        <small><?= isset($arraydeerrores["mail"])? $arraydeerrores["mail"]:"" ?></small>
      </div>

      <div class="col-md-2 mb-3">
        <label for="validationDefault01">Contraseña</label>
        <input type="password" name="contraseña" class="form-control" id="validationDefault01" placeholder="Contraseña"  value="<?= isset($arraydeerrores["contraseña"]) ?"" :$_POST["contraseña"] ?>" >
      ...
      <div class="col-md-2 mb-3">
        ...
        <input type="password" name="recontraseña" class="form-control" id="validationDefaultUsername" placeholder="Contraseña" aria-describedby="inputGroupPrepend2"  value="<?= isset($arraydeerrores["recontraseña"]) ?"" :$_POST["recontraseña"] ?>" > 
