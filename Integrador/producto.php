...
<div class="portada">
    <div class="jumbotron jumbotron-fluid" style="background-color: white; max-heigth: 30%; ">
        <div class="jumbo">
          <img src="img/just-do-it.jpg" alt="" style="max-width: 50%; max-height: 50%;">
        </div>
      </div>
    </div>
...
<section id="zapatillas">
     ...
     <div id="hola" class="card" style="width: 18rem;">
       ...
       <a href="perfilproducto.php"> <img id="hola2" src="img/nike-1.jpg" class="card-img-top" alt="..."></a>
      ...
      <div id="hola" class="card" style="width: 18rem;">
        ...
        <div id="hola" class="card" style="width: 18rem;">
            <a href="perfilproducto.php"><img id="hola2" src="img/nike-4.jpg" class="card-img-top" alt="..."></a>
            <div class="card-body">
